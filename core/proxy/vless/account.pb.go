...
type Account struct {
	...
	// type.
	Dialect       uint32 `protobuf:"varint,10,opt,name=dialect,proto3" json:"dialect,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Account) GetDialect() uint32 {
	if x != nil {
		return x.Dialect
	}
	return 0
...
const file_proxy_vless_account_proto_rawDesc = "" +
	...
	"\bsniffing\x18\x02 \x01(\v2!.xray.app.proxyman.SniffingConfigR\bsniffing\"\xa0\x02\n" +
	"\aAccount\x12\x0e\n" +
	...
	"\btestseed\x18\t \x03(\rR\btestseed\x12\x18\n" +
	"\adialect\x18\n" +
	" \x01(\rR\adialectBR\n" +
